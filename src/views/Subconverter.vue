...
customBackend: {
      "自用专属后端": "https://subapi.520554.xyz",// 为您的后端取名
  ...
  backendOptions: [
      { value: "https://subapi.520554.xyz" }, // 添加您的后端地址
  ...
  form: { // 默认表单配置
        sourceSubUrl: "",
        clientType: "",
        customBackend: this.getUrlParam() == "" ? "https://subapi.520554.xyz" : this.getUrlParam(),// 替换为您的后端地址
